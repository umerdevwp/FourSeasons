...
class Kadence_Blocks_Settings {
	...
	public function add_menu() {
		if ( apply_filters( 'kadence_blocks_admin_menu_options', true ) ) {
			$page = add_options_page( __( 'Datum Blocks -  Gutenberg Page Builder Blocks', 'kadence-blocks' ), __( 'Datum Blocks' ), $this->settings_user_capabilities(), 'kadence_blocks', array( $this, 'config_page' ) );
		} else {
			add_menu_page( __( 'Datum Blocks -  Gutenberg Page Builder Blocks', 'kadence-blocks' ), __( 'Datum Blocks', 'kadence-blocks' ), $this->settings_user_capabilities(), 'kadence-blocks', null, $this->get_icon_svg() );
			$page = add_submenu_page( 'kadence-blocks', __( 'Datum Blocks -  Gutenberg Page Builder Blocks', 'kadence-blocks' ), __( 'Settings' ), $this->settings_user_capabilities(), 'kadence-blocks', array( $this, 'config_page' ) );
		}
	...
	public function scripts() {
		...
		$settings = array(
			'kadence/spacer' => array(
				'moved' => array(
					'type' => 'info',
					'name' => __( 'Setting defaults has moved into Gutenberg, click on the top right corner settings and go to Datum Blocks Controls', 'kadence-blocks' ),
				),
			),
	...
	public function load_api_settings() {
		...
		register_setting(
			...
			array(
				'type'              => 'string',
				'description'       => __( 'Config Datum Block Defaults', 'kadence-blocks' ),
		...
		register_setting(
			...
			array(
				'type'              => 'string',
				'description'       => __( 'Config Datum Block Settings View', 'kadence-blocks' ),
				'sanitize_callback' => 'sanitize_text_field',
				'show_in_rest'      => true,
				'default'           => '',
			)
		...
		register_setting(
			...
			array(
				'type'              => 'string',
				'description'       => __( 'Config Datum Blocks Color Palette', 'kadence-blocks' ),
				'sanitize_callback' => 'sanitize_text_field',
				'show_in_rest'      => true,
				'default'           => '',
			)
		...
		register_setting(
			...
			array(
				'type'              => 'string',
				'description'       => __( 'Config Datum Blocks Global Settings', 'kadence-blocks' ),
				'sanitize_callback' => 'sanitize_text_field',
				'show_in_rest'      => true,
				'default'           => '',
			)
	...
	public function config_page() {
		...
		<div class="kt_plugin_welcome_title_head">
			<div class="kt_plugin_welcome_head_container">
				<a href="http://www.datumsquare.com/" class="kt_plugin_welcome_logo_area">
					...
					<div class="kt_plugin_welcome_logo_title">
						<h1>
							<?php echo esc_html__( 'Datum Blocks', 'kadence-blocks' ); ?>
						</h1>
						<h4>
